...
public class ChessBoard extends JPanel implements MouseMotionListener, MouseListener {
	...
	public ChessBoard() {
		...
		try {
			backgroundImage = ImageIO.read(ChessBoard.class.getResourceAsStream("/picture/qipan.png"));
		} catch (IOException e) {
		...
		mouseCursor = new Cursor(-2, -2, "/picture/cursor-yellow.png");
		chooseCursor = new Cursor(-2, -2, "/picture/cursor-red.png");
	...
	private static void generateWhiteChessList(List<Chess_ol> whiteChessList) {
		...
		// 棋子:车1
		whiteChessList.add(new Rook_ol(141, 1, 8, "/picture/Rook1.png", Team.White));
		// 棋子:马1
		whiteChessList.add(new Knight_ol(131, 2, 8, "/picture/Knight1.png", Team.White));
		// 棋子:象1
		whiteChessList.add(new Bishop_ol(121, 3, 8, "/picture/Bishop1.png", Team.White));
		// 棋子:后1
		whiteChessList.add(new Queen_ol(111, 4, 8, "/picture/Queen1.png", Team.White));
		// 棋子:王
		whiteChessList.add(new King_ol(100, 5, 8, "/picture/King1.png", Team.White));
		// 棋子:象2
		whiteChessList.add(new Bishop_ol(122, 6, 8, "/picture/Bishop1.png", Team.White));
		// 棋子:马2
		whiteChessList.add(new Knight_ol(132, 7, 8, "/picture/Knight1.png", Team.White));
		// 棋子:车2
		whiteChessList.add(new Rook_ol(142, 8, 8, "/picture/Rook1.png", Team.White));

		// 棋子：兵1
		whiteChessList.add(new Pawn_ol(161, 1, 7, "/picture/Pawn1.png", Team.White));
		// 棋子：兵2
		whiteChessList.add(new Pawn_ol(162, 2, 7, "/picture/Pawn1.png", Team.White));
		// 棋子：兵3
		whiteChessList.add(new Pawn_ol(163, 3, 7, "/picture/Pawn1.png", Team.White));
		// 棋子：兵4
		whiteChessList.add(new Pawn_ol(164, 4, 7, "/picture/Pawn1.png", Team.White));
		// 棋子：兵5
		whiteChessList.add(new Pawn_ol(165, 5, 7, "/picture/Pawn1.png", Team.White));
		// 棋子：兵6
		whiteChessList.add(new Pawn_ol(166, 6, 7, "/picture/Pawn1.png", Team.White));
		// 棋子：兵7
		whiteChessList.add(new Pawn_ol(167, 7, 7, "/picture/Pawn1.png", Team.White));
		// 棋子：兵8
		whiteChessList.add(new Pawn_ol(168, 8, 7, "/picture/Pawn1.png", Team.White));
	}
	...
	private static void generateBlackChessList(List<Chess_ol> blackChessList) {
		...
		// 棋子:车1
		blackChessList.add(new Rook_ol(241, 1, 1, "/picture/Rook0.png", Team.BLACK));
		// 棋子:马1
		blackChessList.add(new Knight_ol(231, 2, 1, "/picture/Knight0.png", Team.BLACK));
		// 棋子:象1
		blackChessList.add(new Bishop_ol(221, 3, 1, "/picture/Bishop0.png", Team.BLACK));
		// 棋子:后1
		blackChessList.add(new Queen_ol(211, 4, 1, "/picture/Queen0.png", Team.BLACK));
		// 棋子:王
		blackChessList.add(new King_ol(200, 5, 1, "/picture/King0.png", Team.BLACK));
		// 棋子:象2
		blackChessList.add(new Bishop_ol(222, 6, 1, "/picture/Bishop0.png", Team.BLACK));
		// 棋子:马2
		blackChessList.add(new Knight_ol(232, 7, 1, "/picture/Knight0.png", Team.BLACK));
		// 棋子:车2
		blackChessList.add(new Rook_ol(242, 8, 1, "/picture/Rook0.png", Team.BLACK));

		// 棋子：兵1
		blackChessList.add(new Pawn_ol(261, 1, 2, "/picture/Pawn0.png", Team.BLACK));
		// 棋子：兵2
		blackChessList.add(new Pawn_ol(262, 2, 2, "/picture/Pawn0.png", Team.BLACK));
		// 棋子：兵3
		blackChessList.add(new Pawn_ol(263, 3, 2, "/picture/Pawn0.png", Team.BLACK));
		// 棋子：兵4
		blackChessList.add(new Pawn_ol(264, 4, 2, "/picture/Pawn0.png", Team.BLACK));
		// 棋子：兵5
		blackChessList.add(new Pawn_ol(265, 5, 2, "/picture/Pawn0.png", Team.BLACK));
		// 棋子：兵6
		blackChessList.add(new Pawn_ol(266, 6, 2, "/picture/Pawn0.png", Team.BLACK));
		// 棋子：兵7
		blackChessList.add(new Pawn_ol(267, 7, 2, "/picture/Pawn0.png", Team.BLACK));
		// 棋子：兵8
		blackChessList.add(new Pawn_ol(268, 8, 2, "/picture/Pawn0.png", Team.BLACK));
	}
